## 3.0.0
#### Just a *slight* tweak here.
* I rewrote the entire mod lmao
* Implemented the new Common Void Player API
* The Game Over screen now waits until after the death animation, courtesy of the Common Void Player API.
* The behaviors for Reave's damage are now configurable either in the mod or globally, courtesy of the Common Void Player API. By default it mimics the values of the API.
* Added the option to use local transparency, much like with the Void Jailer mod.
